...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  sved = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/sved",
  ...
  ["vim-startuptime"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/vim-startuptime",
